  ...
  <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-10 bg-gray-800">
    <form action="{{request()->routeIs('alternatives/add') ? route('alternatives/store') : '/alternatives/update/'.$alternative->id}}" method="POST">
      ...
      <div class="mb-6">
        ...
        <input type="number" name="location" id="location" value="{{request()->routeIs('alternatives/edit') ? old('location', $alternative->criteria1) : '' }}"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <div class="mb-6">
        <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price (Rp)</label>
        <input type="number" name="price" id="price" value="{{request()->routeIs('alternatives/edit') ? old('price', $alternative->criteria2) : ''}}"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <div class="mb-6">
        <label for="facility" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Facility (1-5)</label>
        <input type="number" name="facility" id="facility" value="{{request()->routeIs('alternatives/edit') ? old('facility', $alternative->criteria3) : '' }}"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <div class="mb-6">
        <label for="access" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Access (1-5)</label>
        <input type="number" name="access" id="access" value="{{request()->routeIs('alternatives/edit') ? old('access', $alternative->criteria4) : '' }}"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <div class="mb-6">
        <label for="security" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Security (1-5)</label>
        <input type="number" name="security" id="security" value="{{request()->routeIs('alternatives/edit') ? old('security', $alternative->criteria5) : ''}}"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
